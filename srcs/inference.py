...
# from models.k_model import Transformer,ModelConfig
from modelscope import AutoTokenizer, AutoModelForCausalLM
import argparse

class TextGenerator:
    def __init__(self, 
                 checkpoint='./output_models/ckpt/pretrain_1024_18_6144.pth',  # 模型检查点路径
                 tokenizer_model_path='./Tokenizer/',  # 分词器模型路径
                 seed=42,  # 随机种子，确保可重复性
